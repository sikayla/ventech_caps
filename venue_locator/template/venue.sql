...
CREATE TABLE IF NOT EXISTS venue_details (
    ...
    venue_id INT NOT NULL UNIQUE, -- Links to `venues` table
    ...
    gallery_images JSON, -- Stores multiple images as JSON array
    sidebar_gallery JSON, -- Stores sidebar gallery images as JSON array
