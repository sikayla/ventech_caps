...
$places = [
    ...
    ["name" => "Practicing Physical Education (P.E.)", "image" => "/venue_locator/images/act1.png"],
    ["name" => "Practicing Physical Education (P.E.)", "image" => "/venue_locator/images/act2.png"],
    ["name" => "Practicing Physical Education (P.E.)", "image" => "/venue_locator/images/act3.png"],
    ["name" => "Practicing Physical Education (P.E.)", "image" => "/venue_locator/images/act4.png"],
    ["name" => "Practicing Physical Education (P.E.)", "image" => "/venue_locator/images/act1.png"],
];
        ...
        <div id="venueList" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            if ($result->num_rows > 0) {
                while ($venue = $result->fetch_assoc()) {
                    ...
                    $image = (!empty($imagePath) && is_file(__DIR__ . "/" . $imagePath)) ? $imagePath : "uploads/default_court.jpg";
                    ...
                    <div class='bg-white rounded-lg shadow-md overflow-hidden transform transition-all hover:shadow-lg cursor-pointer' onclick='toggleDetails(\"$detailsId\")'>
                        ...
                        <div class='p-4'>
                            ...
                            <div class='hidden-details mt-2' id='$detailsId'>
                                ...
                                <a href='$view_link' class='mt-2 inline-block bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700'>View Venue</a>
                            </div>
                        </div>
                    </div>";
                }
